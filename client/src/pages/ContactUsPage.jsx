      ...
      <section className="py-20 px-6 md:px-12 bg-gradient-to-br from-primary/5 to-primary-container/10">
        <div className="max-w-screen-2xl mx-auto text-center">
          ...
          <button 
            ...
            className="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white font-headline font-bold px-10 py-4 rounded-xl hover:shadow-xl transition-all cursor-pointer border-none"
          >
